...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Paisley. Average arrival 30 to 45 minutes. From £60 local recovery. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        introBlurb:
          'Broken down in Paisley? SRL Recovery is your local 24/7 recovery specialist, serving PA postcodes from Glasgow Airport to Linwood. We dispatch immediately with an average arrival time of 30 to 45 minutes.',
        routeBlurb:
