...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in East Kilbride. Average arrival 30 to 45 minutes. From £60 local recovery. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['G74', 'G75'],
        introBlurb:
          'Need recovery in East Kilbride? SRL Recovery is on call 24 hours a day for breakdowns, accidents, and vehicle transport across G74 and G75. Average arrival time 30 to 45 minutes from your call.',
        routeBlurb:
