...
export const metadata = {
  ...
  description:
    'Broken down at Abington Services or on the M74 near Junction 13? SRL Recovery covers this remote stretch 24/7. Average arrival 45 to 60 minutes. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['ML12'],
        introBlurb:
          'Broken down near Abington Services or stuck on the M74 near Junction 13? SRL Recovery covers this isolated stretch of the M74 around the clock, one of the most remote sections between Hamilton and the Scottish border. Average arrival 45 to 60 minutes from your call.',
        routeBlurb:
