...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Newton Mearns. Covering G77 postcodes and the M77 corridor at junctions 4 to 5. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        routeBlurb:
          'Newton Mearns is our busiest M77 corridor town. We respond daily to breakdowns at M77 junctions 4 to 5, the A726 Stewartfield Way, Ayr Road, and residential streets across Newton Mearns, Crookfur, Waterfoot, Eaglesham, and Mearnskirk. A high-traffic commuter area we know well. Average arrival 30 to 45 minutes.',
