  ...
  return (
    <AreaPage
      area={{
        ...
        routeBlurb:
          'Bishopbriggs is just north of Glasgow, easily reached via the A803 and A8011 corridor. We regularly recover from the A803 Bishopbriggs Road, Springburn Road, and residential streets across Auchinairn, Cadder, Bishopbriggs town centre, and Torrance. Well-known area for our team, average arrival 30 to 45 minutes.',
