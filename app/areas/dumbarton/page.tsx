...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Dumbarton. Average arrival 35 to 50 minutes. From £60. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['G82'],
        introBlurb:
          'Need recovery in Dumbarton? SRL Recovery covers G82 around the clock, breakdowns, accidents, and transport. Average arrival 35 to 50 minutes from your call.',
        routeBlurb:
