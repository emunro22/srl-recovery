...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Coatbridge. Average arrival 30–45 minutes. From £60 local recovery. Call 07776 356 556.',
  alternates: { canonical: '/areas/coatbridge' },
}
