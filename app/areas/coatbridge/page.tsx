...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Coatbridge. Average arrival 30 to 45 minutes. From £60 local recovery. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['ML5'],
        introBlurb:
          'Broken down in Coatbridge? SRL Recovery covers ML5 24 hours a day for breakdowns, accidents, and transport. Average arrival 30 to 45 minutes from your call.',
        routeBlurb:
