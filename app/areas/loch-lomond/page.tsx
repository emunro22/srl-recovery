...
export const metadata = {
  ...
  description:
    'Fast breakdown and accident recovery around Loch Lomond, Balloch, Luss, Tarbet, Arrochar. Average arrival 45 to 65 minutes. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['G83'],
        introBlurb:
          'Broken down near Loch Lomond? SRL Recovery covers the loch side and surrounding villages around the clock, Balloch, Luss, Tarbet and Arrochar included. Average arrival 45 to 65 minutes from your call.',
        routeBlurb:
