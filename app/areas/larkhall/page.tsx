  ...
  return (
    <AreaPage
      area={{
        ...
        routeBlurb:
          'Larkhall sits south of Hamilton on the A72 corridor. We cover Larkhall town centre, the A72 Larkhall Road, and surrounding villages including Stonehouse, Blackwood, Machan, and Meadowhill. M74 access at junction 7 means quick dispatch from our Motherwell base. Average arrival 25 to 40 minutes.',
