...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Cambuslang. Average arrival 25 to 40 minutes. From £60. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['G72'],
        introBlurb:
          "Need recovery in Cambuslang? SRL Recovery covers G72 24/7, breakdowns, accidents, transport. Average arrival 25 to 40 minutes from your call, and we know the area inside-out.",
        routeBlurb:
