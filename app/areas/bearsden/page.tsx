...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Bearsden. Average arrival 30 to 45 minutes. From £60. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['G61'],
        introBlurb:
          'Need recovery in Bearsden? SRL Recovery covers G61 24 hours a day for breakdowns, accidents, and vehicle transport. Average arrival 30 to 45 minutes from your call.',
        routeBlurb:
