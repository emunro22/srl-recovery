...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Clydebank. Average arrival 30 to 45 minutes. From £60 local recovery. Call 01698 700970.',
  alternates: { canonical: 'https://srlrecovery.com/areas/clydebank' },
}
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['G81'],
        introBlurb:
          'SRL Recovery is on call 24/7 for breakdowns, accidents, and vehicle transport across Clydebank and the wider G81 area. Average arrival 30 to 45 minutes from your call.',
        routeBlurb:
