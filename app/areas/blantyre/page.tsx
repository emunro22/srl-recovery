  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['G72'],
        introBlurb:
          '24/7 breakdown recovery in Blantyre and G72 postcodes. SRL Recovery covers Blantyre and the Caledonian Road corridor fast from our nearby Motherwell base, average arrival 20 to 30 minutes.',
        routeBlurb:
