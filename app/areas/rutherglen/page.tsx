...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Rutherglen. Average arrival 25 to 40 minutes. From £60. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['G73'],
        introBlurb:
          'Rutherglen is well within our core coverage. SRL Recovery handles breakdowns, accidents, and transport across G73 around the clock, average arrival 25 to 40 minutes from your call.',
        routeBlurb:
