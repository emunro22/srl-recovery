...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Hamilton. Average arrival 30 to 45 minutes. From £60 local recovery. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        postcodes: ['ML3', 'ML9'],
        introBlurb:
          'Need a recovery in Hamilton? SRL Recovery covers ML3 and ML9 around the clock for breakdowns, accidents, and vehicle transport. Average arrival 30 to 45 minutes from your call.',
        routeBlurb:
