...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Bellshill. Average arrival 20 to 35 minutes. From £60. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        routeBlurb:
          'Being close to our Motherwell base, Bellshill jobs are typically with us in 20 to 35 minutes. We cover the town centre, Mossend, Orbiston, Tannochside, and the surrounding industrial estates. The A721 and the M74 junctions through this area are some of our most common call locations.',
