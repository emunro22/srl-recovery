  ...
  return (
    <AreaPage
      area={{
        ...
        routeBlurb:
          'Cumbernauld sits on the M80 which we cover every day. We recover from the M80 interchanges at junctions 4 to 6, the A80, A8011, and throughout Cumbernauld town centre, Kildrum, Abronhill, Condorrat, and Craigmarloch. Whether you\'re stuck on the motorway or in a housing estate, we know the roads here. Average arrival 30 to 45 minutes.',
