...
export const metadata = {
  ...
  description:
    'Fast 24/7 breakdown and accident recovery in Glasgow city centre. Covering G1 to G5, the M8, Kingston Bridge and all inner-city roads. Call 01698 700970.',
  ...
  return (
    <AreaPage
      area={{
        ...
        introBlurb:
          'Broken down in Glasgow city centre? SRL Recovery dispatches immediately to all G1 to G5 postcodes, from the Merchant City to Finnieston, Charing Cross to the Southside. 24/7 recovery with average arrival of 20 to 35 minutes.',
        routeBlurb:
